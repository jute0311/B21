...
from players.B21.decidethebesthand6 import decideTheBestHand6
from players.B21.makefield import *

import time

class CPlayerV6(Player):
	def __init__(self):
		super().__init__()
	...
	def move(self, board, pieces):
		...
		if self.count == 1:
			...
			hand = decideTheBestHand6(self.number,field,player1,pieces,self.count,board)

...
from players.B21V7.decidethebesthand8 import decideTheBestHand8
from players.B21.makefield import *

import time

class CPlayerV8(Player):
	def __init__(self):
		super().__init__()
	...
	def move(self, board, pieces):
		...
		if self.count == 1:
			...
			hand = decideTheBestHand8(self.number,field,player1,pieces,self.count,board)
